...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--scenario-seed-offset", type=int, default=510000)
...
def main() -> None:
    ...
    bank = _move_bank(
        build_dagger_scenario_bank(64, seed=args.seed + args.scenario_seed_offset, dt=simulator.params.dt), device
    )
