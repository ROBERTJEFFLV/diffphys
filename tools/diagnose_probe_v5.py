...
def code_hashes() -> dict:
    return {name: file_hash(ROOT / name) for name in (
        ...
        "structured_allocator.py", "structured_training_runtime.py",
        "structured_checkpoint.py", "structured_local_distillation.py",
        "tools/pretrain_structured_identifier.py", "tools/distill_structured_dagger.py",
        "tools/run_structured_pipeline.py", "tools/train_structured_full_space.py",
        "tools/distill_structured_local_gain.py", "tools/validate_structured_residual_oracle.py",
        "tools/calibrate_structured_capability.py", "tools/postcalibration_local_evidence.py",
        "tools/validate_structured_q2_migration.py")}
