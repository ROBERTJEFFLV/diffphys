...
namespace rl_tools::rl::environments::l2f{
    ...
    template <typename T_SPEC>
    struct ParametersDisturbances: T_SPEC::NEXT_COMPONENT{
        using SPEC = T_SPEC;
        using NEXT_COMPONENT = typename T_SPEC::NEXT_COMPONENT;
        static constexpr typename T_SPEC::TI N = NEXT_COMPONENT::N;
        using Disturbances = parameters::Disturbances<typename T_SPEC::T>;
    ...
    template <typename T_SPEC>
    struct ParametersDomainRandomization: T_SPEC::NEXT_COMPONENT{
        using SPEC = T_SPEC;
        using NEXT_COMPONENT = typename T_SPEC::NEXT_COMPONENT;
        static constexpr typename T_SPEC::TI N = NEXT_COMPONENT::N;
        using DomainRandomization = parameters::DomainRandomization<typename T_SPEC::T>;
    ...
    struct ParametersTrajectory: T_SPEC::NEXT_COMPONENT{
        ...
        static constexpr typename SPEC::TI N = NEXT_COMPONENT::N;
