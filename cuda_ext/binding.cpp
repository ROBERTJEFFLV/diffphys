...
std::vector<torch::Tensor> step_forward(
    ...
    const auto batch = position.size(0);
    check_1d(mass, "mass", batch);
    check_2d(thrust_coeff_c0, "thrust_coeff_c0", batch, 4);
    check_2d(thrust_coeff_c1, "thrust_coeff_c1", batch, 4);
    check_2d(thrust_coeff_c2, "thrust_coeff_c2", batch, 4);
    check_1d(motor_time_rising, "motor_time_rising", batch);
    check_1d(motor_time_falling, "motor_time_falling", batch);
    check_1d(arm_length, "arm_length", batch);
    check_1d(inertia_x, "inertia_x", batch);
    check_1d(inertia_y, "inertia_y", batch);
    check_1d(inertia_z, "inertia_z", batch);
    check_1d(rotor_torque_constant, "rotor_torque_constant", batch);
    return l2f_step_forward_cuda(
        ...
        motor_time_rising, motor_time_falling, arm_length,
        inertia_x, inertia_y, inertia_z, rotor_torque_constant,
        dt, gravity);
}
