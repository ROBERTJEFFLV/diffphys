...
#include "config.h"
#ifdef RL_TOOLS_ENABLE_EXPERIMENTAL_SAC_DIFF
#include "../../../../../rl/algorithms/sac/diff_actor_update.h"
#endif
...
#ifdef RL_TOOLS_ENABLE_EXPERIMENTAL_SAC_DIFF
            rl::algorithms::sac::train_actor_differentiable_physics(device, ts);
#endif
        }
