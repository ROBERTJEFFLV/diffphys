...
#if (defined(RL_TOOLS_BACKEND_ENABLE_MKL) || defined(RL_TOOLS_BACKEND_ENABLE_ACCELERATE) || defined(RL_TOOLS_BACKEND_ENABLE_OPENBLAS) || defined(RL_TOOLS_BACKEND_ENABLE_CUDA)) && !defined(RL_TOOLS_BACKEND_DISABLE_BLAS)
...
#if defined(RL_TOOLS_RL_ZOO_ALGORITHM_SAC) || defined(RL_TOOLS_RL_ZOO_ALGORITHM_SAC_DIFF)
...
#if defined(RL_TOOLS_RL_ZOO_ALGORITHM_SAC_DIFF)
using LOOP_CORE_CONFIG = rlt::rl::zoo::l2f::sac_diff::FACTORY<DEVICE, T, TI, RNG, DYNAMIC_ALLOCATION>::LOOP_CORE_CONFIG;
#else
...
struct LOOP_NN_ANALYTICS_PARAMETERS: LOOP_EVALUATION_PARAMETER_OVERWRITES<rlt::rl::loop::steps::nn_analytics::Parameters<T, TI, LOOP_CHECKPOINT_CONFIG>>{
    ...
    static constexpr TI INTERVAL = INTERVAL_TEMP == 0 ? 1 : INTERVAL_TEMP;
#if defined(RL_TOOLS_RL_ZOO_ALGORITHM_SAC) || defined(RL_TOOLS_RL_ZOO_ALGORITHM_SAC_DIFF) || defined(RL_TOOLS_RL_ZOO_ALGORITHM_TD3)
...
#if defined(RL_TOOLS_RL_ZOO_ALGORITHM_SAC_DIFF)
std::string algorithm = "sac_diff";
#elif defined(RL_TOOLS_RL_ZOO_ALGORITHM_SAC)
