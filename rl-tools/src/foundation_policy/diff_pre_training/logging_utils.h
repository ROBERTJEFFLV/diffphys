...
namespace rl_tools::foundation_policy::diff_pre_training{
    ...
    inline void write_training_csv_header(std::ofstream& log_file){
        log_file << "seed,step,mode_fixed_or_sampled,diff_model,physics_gradient_enabled,reset_hidden_each_step,"
                 ...
                 << "clf_loss_mean,window_clf_loss_mean,outward_velocity_loss_mean,attitude_control_loss_mean,"
                 << "velocity_barrier_loss_mean,angular_velocity_barrier_loss_mean,attitude_barrier_loss_mean,"
                 ...
                 << "loss_clf,loss_outward_velocity,loss_attitude_control,"
