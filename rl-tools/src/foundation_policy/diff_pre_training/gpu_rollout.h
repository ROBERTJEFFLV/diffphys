...
struct FullGpuTrainingSummary{
    ...
    float window_position_norm_mean = 0.0f;
    float window_velocity_norm_mean = 0.0f;
    float window_attitude_error_mean = 0.0f;
    float window_angular_velocity_norm_mean = 0.0f;
    float window_position_norm_max_mean = 0.0f;
    float window_velocity_norm_max_mean = 0.0f;
    float window_attitude_error_max_mean = 0.0f;
    float window_angular_velocity_norm_max_mean = 0.0f;
    float window_position_norm_max = 0.0f;
    float window_velocity_norm_max = 0.0f;
    float window_attitude_error_max = 0.0f;
    float window_angular_velocity_norm_max = 0.0f;
